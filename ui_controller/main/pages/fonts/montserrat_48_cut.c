 ...
 * Size: 48 px
 * Bpp: 4
 * Opts: --bpp 4 --size 48 --no-compress --font Montserrat-Medium.ttf --symbols -1234567890 --format lvgl -o montserrat_48_cut.c
 ******************************************************************************/
...
#ifndef MONTSERRAT_48_CUT
#define MONTSERRAT_48_CUT 1
#endif

#if MONTSERRAT_48_CUT
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t montserrat_48_cut = {
#else
lv_font_t montserrat_48_cut = {
#endif
